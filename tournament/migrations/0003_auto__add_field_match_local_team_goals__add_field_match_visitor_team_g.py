...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.local_team_goals'
        db.add_column('tournament_match', 'local_team_goals', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Match.visitor_team_goals'
        db.add_column('tournament_match', 'visitor_team_goals', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.local_team_goals'
        db.delete_column('tournament_match', 'local_team_goals')

        # Deleting field 'Match.visitor_team_goals'
        db.delete_column('tournament_match', 'visitor_team_goals')
