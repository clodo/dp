...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserMatchPrediction.is_double'
        db.add_column('tournament_usermatchprediction', 'is_double', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserMatchPrediction.is_double'
        db.delete_column('tournament_usermatchprediction', 'is_double')
