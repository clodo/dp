...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fixture.is_finished'
        db.add_column('tournament_fixture', 'is_finished', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fixture.is_finished'
        db.delete_column('tournament_fixture', 'is_finished')
